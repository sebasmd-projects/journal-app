# Generated by Django 4.0.5 on 2022-06-17 19:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designa si el usuario está activo', verbose_name='Es un usuario activo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(help_text='Nombres del usuario', max_length=40, verbose_name='Nombres')),
                ('last_name', models.CharField(help_text='Apellidos del usuario', max_length=40, verbose_name='Apellidos')),
                ('full_name', models.CharField(help_text='Nombres y apellidos del usuario', max_length=100, verbose_name='Nombres y Apellidos')),
                ('phone', models.CharField(help_text='Celular o teléfono del usuario', max_length=20, verbose_name='Celular o teléfono')),
                ...
                ('birthday', models.DateField(help_text='Fecha de nacimiento del usuario', verbose_name='Fecha de nacimiento')),
                ('age', models.CharField(default=0, help_text='Edad del usuario', max_length=4, verbose_name='Edad')),
                ('gender', models.CharField(choices=[('M', 'Hombre'), ('W', 'Mujer'), ('O', 'Otro')], max_length=1, verbose_name='Género')),
                ...
                ('updated', models.DateTimeField(auto_now=True, help_text='Fecha de edición del usuario', verbose_name='Fecha de edición')),
                ('order', models.PositiveIntegerField(default=0, help_text='Orden de visualización', verbose_name='Orden')),
                ('user', models.OneToOneField(help_text='Usuario registrado', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='ID de Usuario')),
            ],
            options={
