...
function defaultMode(e) {
    ...
    if (mode == "dark") {
        ...
        x.setAttribute('href', '/static/css/wozia/style-dark.css')
        y.setAttribute('data-class', mode)
    }else{
        var x = document.getElementById("app-css");
        var y = document.getElementById("mode");  
        x.setAttribute('href', '/static/css/wozia/style.css')
        y.setAttribute('data-class', mode)
    }    
}
...
function setColor(theme) {
    ...
    document.getElementById('color-opt').href = '/static/css/wozia/colors/' + theme + '.css';
...
function defaultColor(e) {
    ...
    document.getElementById('color-opt').href = '/static/css/wozia/colors/' + color + '.css';
}